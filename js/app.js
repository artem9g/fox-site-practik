(() => {
    ...
    function initSliders() {
        let nswiper;
        if (document.querySelector(".portfolio__slider")) nswiper = new swiper_core_Swiper(".portfolio__slider", {
        ...
        if (document.querySelector(".swiper-testimonial")) swiperTestimonialBottom = new swiper_core_Swiper(".swiper-testimonial", {
            ...
            navigation: true,
            pagination: {
                el: ".testimonial__navigation>.swiper-pagination-bottom",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
    ...
    da.init();
    const numberElements = document.querySelectorAll(".diagram__number");
    numberElements.forEach((numberElement => {
        const textContent = numberElement.textContent;
        const value = parseFloat(textContent.replace("%", ""));
        const parentLineElement = numberElement.parentElement.nextElementSibling;
